...
/// <summary>
/// States that the decorated class or interface is a scoped service that is registered
/// specifically by Dependency Injection container.
/// <para>
/// This optionally allow to define the class or interface to be an ambient service.
/// It is simpler to use the CK.Core.IAmbientAutoService interface marker : this defines
/// an auto service that automatically handles specialization.
/// </para>
/// </summary>
