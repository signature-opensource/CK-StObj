...
/// <summary>
/// Specialized <see cref="PrimaryTypeAttributeImpl"/> with a strongly typed <see cref="Attribute"/>.
...
public abstract class PrimaryTypeAttributeImpl<TAttr> : PrimaryTypeAttributeImpl where TAttr : class
{
    private protected override bool OnInitFields( IActivityMonitor monitor )
    {
        return CheckAttributeType( monitor, GetType(), _attribute.GetType(), typeof( TAttr ) );
    }
