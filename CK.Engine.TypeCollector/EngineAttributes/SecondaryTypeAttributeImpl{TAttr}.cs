...
/// <summary>
/// Specialized <see cref="SecondaryTypeAttributeImpl"/> with a strongly typed <see cref="Attribute"/>.
...
public abstract class SecondaryTypeAttributeImpl<TAttr> : SecondaryTypeAttributeImpl where TAttr : class
{
