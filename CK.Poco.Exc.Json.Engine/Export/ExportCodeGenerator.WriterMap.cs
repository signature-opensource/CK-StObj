...
//            CodeWriter GetWriter( IPocoType t )
//            {
//                Throw.DebugAssert( _nameMap.TypeSet.Contains( t ) && !t.IsNullable );
//                Throw.DebugAssert( "PocoTypeSet filters out ImplementationLess types.", !t.ImplementationLess );
...
//            CodeWriter GetRecordCodeWriter( IPocoType type )
//            {
...
//                // We want array to use AsSpan(), list to to use CollectionsMarshal.AsSpan and hashset to use the IEnumerable.
//                //
//                switch( c.Kind )
//                {
//                    case PocoTypeKind.Array:
//                        return ( writer, v ) => writer.Append( "CK.Poco.Exc.JsonGen.Exporter.WriteA" )
//                                                      .Append( tI.Index )
//                                                      .Append( "(w," ).Append( v ).Append( ", wCtx);" );
//                    case PocoTypeKind.List:
//                        return ( writer, v ) => writer.Append( "CK.Poco.Exc.JsonGen.Exporter.WriteL" )
//                                                      .Append( tI.Index )
//                                                      .Append( "(w," ).Append( v ).Append( ", wCtx);" );
//                    default:
//                        return ( writer, v ) => writer.Append( "CK.Poco.Exc.JsonGen.Exporter.WriteS" )
//                                                      .Append( tI.Index )
//                                                      .Append( "(w," ).Append( v ).Append( ", wCtx);" );
//                }
//            }
