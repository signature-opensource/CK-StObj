...
namespace CK.Setup
{
    ...
    /// </summary>
    sealed class UnionTypeDefinition
    {
        readonly List<PropertyInfo> _types;

        public UnionTypeDefinition( bool canBeExtended, List<PropertyInfo> types )
        {
            _types = types;
        ...
        /// <summary>
        /// Gets the types, sorted by their type's FullName. This is used by
        /// <see cref="HasSameVariantsAs(UnionType)"/>: SequenceEquals can be used.
        /// </summary>
        public IReadOnlyList<PropertyInfo> Types => _types;

        public bool CanBeExtended { get; set; }

        public UnionTypeDefinition Clone()
        {
            Debug.Assert( CanBeExtended, "Useless to clone otherwise." );
            return new UnionTypeDefinition( CanBeExtended, new List<PropertyInfo>( _types ) );
        }
        ...
        //                              out UnionTypeDefinition? unionType )
        //{
        //    unionType = null;
        ...
        //        }
        //        unionType = new UnionTypeDefinition( unionAttr.CanBeExtended, types );
        //    }
        //    return true;
        //}
