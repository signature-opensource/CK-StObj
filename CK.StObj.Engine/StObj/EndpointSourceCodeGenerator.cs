...
namespace CK.StObj
{
    ...
    sealed class EndpointType<TScopeData> : IEndpointType<TScopeData>, IEndpointTypeInternal where TScopeData : notnull
    {
        ...
        public Type InstanceDataType => typeof(TScopeData);
...
""";
        ...
        internal static void GenerateEndpointCode( ITypeScope rootType, IEndpointResult endpointResult )
        {
            ...
            // Adds the CK.StObj.EndpointType<TScopeData>, GlobalHook, IEndpointTypeInternal and static EndpointHelper.
            ...
            rootType.Append( """
                             ...
                             {
                                 var common = EndpointHelper.CreateCommonEndpointContainer( reg.Monitor, reg.Services, CK.Core.EndpointTypeManager_CK._endpointServices.Contains );
                                 var theEPTM = new CK.Core.EndpointTypeManager_CK();
