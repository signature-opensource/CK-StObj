...
namespace CK.Setup
{
    partial class StObjCollector
    {
        void AddWellKnownServices( IActivityMonitor monitor )
        {
            ...
            //
            SetAutoServiceKind( monitor, typeof( IActivityMonitor ), AutoServiceKind.IsContainerConfiguredService | AutoServiceKind.IsScoped );
            SetAutoServiceKind( monitor, typeof( IParallelLogger ), AutoServiceKind.IsContainerConfiguredService | AutoServiceKind.IsScoped );
            ...
            SetAutoServiceKind( monitor, "Microsoft.Extensions.Options.IOptionsSnapshot`1, Microsoft.Extensions.Options", AutoServiceKind.IsScoped, isOptional: true );
            SetAutoServiceKind( monitor, "Microsoft.Extensions.Options.IOptions`1, Microsoft.Extensions.Options", AutoServiceKind.IsSingleton, isOptional: true );
            // IOptionsMonitor is independent.
            SetAutoServiceKind( monitor, "Microsoft.Extensions.Options.IOptionsMonitor`1, Microsoft.Extensions.Options", AutoServiceKind.IsSingleton, isOptional: true );
            ...
            SetAutoServiceKind( monitor, "CK.AspNet.ScopedHttpContext, CK.AspNet", AutoServiceKind.IsContainerConfiguredService|AutoServiceKind.IsScoped, isOptional: true );
        }
    }
}
