...
namespace CK.Core
{
    ...
    {
        /// <summary>
        /// Dictionary for non nullable value type of <typeparamref name="TValue"/> that is also
        /// IReadOnlyDictionary&lt;TKey, TValue?&gt; and a IReadOnlyDictionary&lt;TKey, object&gt;.
        /// <para>
        /// It should also be a IReadOnlyDictionary&lt;object, TValue&gt;, IReadOnlyDictionary&lt;object, TValue?&gt; and
        /// a IReadOnlyDictionary&lt;object, object&gt; but unfortunately this is not possible (Compiler Error CS0695).
        /// </para>
        /// </summary>
            ...
            where TValue : struct
        {
            ...
            /// </summary>
            public CovNotNullValueDictionary() { }
            ...
            public CovNotNullValueDictionary( IEnumerable<KeyValuePair<TKey, TValue>> collection )
                : base( collection )
            {
            }
            ...
            /// </param>
            public CovNotNullValueDictionary( IEqualityComparer<TKey>? comparer )
                : base( comparer )
            {
            }
            ...
            public CovNotNullValueDictionary( int capacity )
                : base( capacity )
            {
            }
            ...
            public CovNotNullValueDictionary( IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer )
            ...
            /// <param name="collection">The initial content.</param>
            /// <param name="comparer">The comparer to use. Null to use the default comparer for the key type.</param>
            public CovNotNullValueDictionary( IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer )
            ...
            /// <param name="capacity">The initial capacity.</param>
            /// <param name="comparer">The comparer to use. Null to use the default comparer for the key type.</param>
            public CovNotNullValueDictionary( int capacity, IEqualityComparer<TKey>? comparer )
