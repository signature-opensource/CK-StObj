...
{
    /// <summary>
    /// Marks a class as being a Poco class object:
    /// <list type="bullet">
    ...
    /// </list>
    /// A Poco class object behaves like a IPoco.
    /// <para>
    ...
    /// named "PocoClassAttribute" defined in any namespace will be considered.
    /// </para>
    /// </summary>
    [AttributeUsage(AttributeTargets.Class)]
    public class PocoClassAttribute : Attribute
    {
    }
}
