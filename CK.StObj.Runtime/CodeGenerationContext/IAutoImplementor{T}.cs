...
namespace CK.Setup
{
    ...
    {
        /// <summary>
        /// Implements the given method, property or type on the given <see cref="ITypeScope"/>.
        ...
        /// </returns>
        AutoImplementationResult Implement( IActivityMonitor monitor, T m, ICodeGenerationContext c, ITypeScope typeBuilder );
    }
