...
namespace CK.Setup
{
    ...
    /// This could be done if supporting Json serialization of other type families than IPoco is required. 
    /// </para>
    /// </summary>
    public interface IJsonSerializationCodeGen
    {
        ...
        /// the generic parameter types must themselves be known (see <see cref="IsKnownType(Type)"/>).
        /// </summary>
