...
namespace CK.Testing.StObjMap
{
    ...
    public interface IStObjMapTestHelperCore
    {
        ...
        /// (where #num is an incremented number starting at 1) to <see cref="StObjContextRoot.GeneratedAssemblyName"/> so
        ...
        /// <summary>
        /// Deletes all files like <see cref="StObjContextRoot.GeneratedAssemblyName"/>.Reset.#num
