...
namespace CK.StObj.Engine.Tests.Service
{
    ...
    public class BasicServiceLifetimeTests
    {
        ...
        public void a_class_with_both_scopes_is_an_error()
        {
            ...
            TestHelper.GetFailedResult( collector, "Invalid CK type combination 'IsAutoService|IsScoped|IsSingleton': An interface or an implementation cannot be both Scoped and Singleton" );
        }
